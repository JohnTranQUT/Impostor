...
namespace Impostor.Patcher.WinForms.Forms
{
    public partial class FrmMain : Form
    {
        ...
        private async void buttonLaunch_Click(object sender, EventArgs e)
        {
            ...
            await _modifier.SaveIpAsync(comboIp.Text == "RankedAmongUs ASIA" ? "as1.rankedamongus.com" : comboIp.Text == "RankedAmongUs EU" ? "eu1.rankedamongus.com": "na1.rankedamongus.com");
        }
